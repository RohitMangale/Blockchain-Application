...
const Transactions = () => {
  ...
  const TransactionCard = ({ addressTo, addressFrom, amount, timestamp, message, keyword, url }) => {
  const gifUrl = useFetch({keyword})
    return (
      <div className="m-4 flex flex-1 bg-[#181918] 2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl">
